...
import { createReviewFail, 
 ...
 export const getProducts =  (keyword,price,category, rating, currentPage) =>async (dispatch) => {
    try{
        ...
        let link=`https://capstone-be-sjfr.vercel.app/api/v1/products?page=${currentPage}`;
 ...
 export const getProduct = id => async (dispatch) => {
    try{
        ...
        const { data} = await axios.get(`https://capstone-be-sjfr.vercel.app/api/v1/product/${id}`);
...
export const createReview = (reviewData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put('https://capstone-be-sjfr.vercel.app/api/v1/review', reviewData, config);
...
export const getAdminProducts = async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('https://capstone-be-sjfr.vercel.app/api/v1/admin/product', {
            headers: {
...
export const createNewProduct = (productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post('https://capstone-be-sjfr.vercel.app/api/v1/admin/product/new', formData, {
            headers: {
 ...
 export const deleteProduct = (id) => async (dispatch) => {
    try {
        ...
        await axios.delete(`https://capstone-be-sjfr.vercel.app/api/v1/admin/product/${id}`, {
            headers: {
 ...
 export const updateProduct = (id, productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(
            `https://capstone-be-sjfr.vercel.app/api/v1/admin/product/${id}`, 
            productData,
            {
                headers: {
...
export const getReviews = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('https://capstone-be-sjfr.vercel.app/api/v1/admin/reviews', {
...
export const deleteReview = (productId, id) => async (dispatch) => {
    try {
        ...
        await axios.delete('https://capstone-be-sjfr.vercel.app/api/v1/admin/review', {
