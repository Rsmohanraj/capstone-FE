...
import { adminOrderFail, adminOrderRequest, adminOrderSuccess, createOrderFail, 
     ...
     userOrderFail,
      userOrderRequest,
       ...
       export const CreateOrder = (order) => async (dispatch) => {
        try {
          ...
          const { data } = await axios.post('https://capstone-be-jade.vercel.app/api/v1/order/new', order, {
            headers: {
      ...
      export const userOrders = async (dispatch) => {
        try {
            ...
            const { data } = await axios.get('https://capstone-be-jade.vercel.app/api/v1/my/orders', {
                headers: {
                    'Authorization': `Bearer ${token}`,
    ...
    export const orderDetail = (id) => async (dispatch) => {
        try {
            ...
            // Make the GET request with the Authorization header
            const { data } = await axios.get(`https://capstone-be-jade.vercel.app/api/v1/order/${id}`, {
                headers: {
                    'Authorization': `Bearer ${token}`,
    ...
    export const adminOrders = async (dispatch) => {
        try {
            ...
            // Make the GET request with the Authorization header
            const { data } = await axios.get('https://capstone-be-jade.vercel.app/api/v1/admin/orders', {
                headers: {
    ...
    export const deleteOrder = (id) => async (dispatch) => {
        try {
            ...
            await axios.delete(`https://capstone-be-jade.vercel.app/api/v1/admin/order/${id}`, {
                headers: {
    ...
    export const updateOrder = (id, orderData) => async (dispatch) => {
        try {
            ...
            const { data } = await axios.put(`https://capstone-be-jade.vercel.app/api/v1/admin/order/${id}`, orderData, {
                headers: {
