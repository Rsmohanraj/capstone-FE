...
import { deleteUserFail, 
    ...
    export const login = (email, password) => async (dispatch) => {
      try {
        ...
        const { data } = await axios.post('https://capstone-be-sjfr.vercel.app/api/v1/login', { email, password });
    ...
    export const register = (userData) => async (dispatch) => {
      try {
        ...
        const { data } = await axios.post('https://capstone-be-sjfr.vercel.app/api/v1/register', userData);
...
export const loadUser = async (dispatch) => {
  try {
    ...
    const { data } = await axios.get('https://capstone-be-sjfr.vercel.app/api/v1/userprofile', {
      headers: {
...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put('https://capstone-be-sjfr.vercel.app/api/v1/update', userData, config);
...
export const forgetPassword =(formData) => async(dispatch)=>{
   try{
       ...
       const config ={
        ...
        const {data}  = await axios.post('https://capstone-be-sjfr.vercel.app/api/v1//Password/forget',formData,config);
...
export const resetPassword =(formData,token) => async(dispatch)=>{
   try{
       ...
       const config ={
        ...
        const {data}  = await axios.post(  `https://capstone-be-sjfr.vercel.app/api/v1/password/reset/${token}`,formData,config);
...
export const getUsers = async (dispatch) => {
  try {
      ...
      const { data } = await axios.get('https://capstone-be-sjfr.vercel.app/api/v1/admin/users', {
          headers: {
...
export const getUser  = id =>  async(dispatch)=>{
   try{
     ...
     const {data} = await axios.get(`https://capstone-be-sjfr.vercel.app/api/v1/admin/user/${id}`,{
       headers:{
           'content-type': "application/json",
...
export const deleteUser = (id) => async (dispatch) => {
  try {
    ...
    await axios.delete(`https://capstone-be-sjfr.vercel.app/api/v1/admin/user/${id}`, {
      headers: {
        'Content-Type': 'application/json',
...
export const updateUser = (id, formData) => async (dispatch) => {
  try {
    ...
    const response = await axios.put(`https://capstone-be-sjfr.vercel.app/api/v1/admin/user/${id}`, formData, {
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`, // Pass the token in the Authorization header
      },
